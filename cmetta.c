 ...
 *   no allocation [tested: tests/test_ownership.c; commit=1a60e2a3cce69d5d6bda67100186939d707f4397].
...
/* Validate before SWI's replacement decoder can silently change malformed
   ...
   [source: https://www.rfc-editor.org/rfc/rfc3629.txt; commit=1a60e2a3cce69d5d6bda67100186939d707f4397]
  ...
  *out = NULL;   /* see run_or_load: zeroed before anything can fail. */
  ...
  { term_t parts = PL_new_term_refs(2);
    ...
    { /* The record owns either a suspended engine or transaction-held rows.
         ...
         [tested: tests/test_cursor_ids.c; commit=1a60e2a3cce69d5d6bda67100186939d707f4397] */
...
/* The query is one engine expression, so pattern and guard share variable cells.
   ...
   [tested: test_prepared_queries_join_and_guard_current_facts; commit=1a60e2a3cce69d5d6bda67100186939d707f4397] */
...
/* Committed change callbacks share registration lifetime with providers.
   ...
   [tested: tests/test_subscriptions.c; commit=1a60e2a3cce69d5d6bda67100186939d707f4397] */
...
/* Match the actual enclosing transaction, not an equal copy of its goal.
   ...
   src/pl-fli.c:PL_same_compound; commit=1a60e2a3cce69d5d6bda67100186939d707f4397] */
static bool registry_writable(const char *door)
